...
import { AiFillCar, AiOutlineCar, AiOutlineClockCircle, AiOutlineEye, AiOutlineSetting } from 'react-icons/ai';
        ...
        <div className="text-center  text-3xl min-h-screen   bg-gray-100">
          loading...
           ...
           {Condition === "Brand New" ? (
              ...
              <h1 className="text-white bg-red-600 rounded-lg py-2 px-4 mb-2 inline">Used</h1>
            )}

<h1 className="pb-2 font-bold text-xl md:text-3xl  text-black ">{Name} </h1>

   <div className="flex items-center mb-4">
          <AiOutlineClockCircle fill='red'></AiOutlineClockCircle>
          <span className="text-gray-400 mx-2 ">ListedOn: {ListedOn}</span>
         ...
         <Image
          ...
          />
           ...
           <div className='bg-white p-6 rounded-lg shadow-lg col-span-2  mx-5  md:ml-20 mb-10 flex  flex-col items-start'>
            <h1 className="pb-3 font-bold text-xl md:text-2xl  text-black ">Key Information</h1>
            <div className='grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8' >
              <div className='flex   gap-3'>
              <AiOutlineCar className='text-2xl' fill='red'></AiOutlineCar>
                <div>
              ...
              <div className='flex   gap-3'>
              <AiOutlineSetting className='text-2xl' fill='red'></AiOutlineSetting>
                <div>
              ...
              <div className='flex   gap-3'>
              <BsFillFuelPumpFill className='text-2xl' fill='red'></BsFillFuelPumpFill>
                <div>
              ...
              <div className='flex   gap-3'>
              <SiUnrealengine className='text-2xl' fill='red'></SiUnrealengine>
                <div>
              ...
              <div className='flex   gap-3'>
              <SiAirplayaudio className='text-2xl' fill='red'></SiAirplayaudio>
                <div>
